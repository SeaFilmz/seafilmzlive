...
<?php
  $title = 'Anchorage, Alaska Actors by First Name or by Birthdate - SeaFilmz';
  $mDesc = 'List of actors born is the city of Anchorage, Alaska organized by first name or by birthdate.';
  $ogTitle = 'Anchorage, Alaska Actors by First Name or by Birthdate - SeaFilmz';
  $ogURL = 'https://seafilmz.com/anchorage-alaska-actors';
  $body = 'MainBody';
...
?>
    ...
    <p class="ActorsPageHeader">
      <b>
        <a href="anchorage-alaska-actors-beta">New Actors Data UI Beta</a>
      </b>
    </p>
...
?>
    ...
    <!--link to Total Actors Count-->
<?php peopleCityBornByJobCount('Anchorage', 'actor'); ?>
