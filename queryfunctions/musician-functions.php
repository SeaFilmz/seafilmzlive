      ...
      <table class="PeoplesCountTable">
        <tr>
          ...
          <?php
              ...
              $query = $newconnection->prepare("SELECT COUNT(*) peoplecount FROM peoples_jobs INNER JOIN peoples ON peoples.people_id = peoples_jobs.PeopleID INNER JOIN jobs ON  = peoples_jobs.JobID INNER JOIN cities ON  = peoples.birth_city_id WHERE city = ? AND jobs = ? AND MusicianName IS NOT NULL ");
