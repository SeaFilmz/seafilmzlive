...
<div class="MCTable">
        ...
        <?php
            ...
            $query = $newconnection->prepare("SELECT COUNT(*) FROM movies_cities INNER JOIN movies ON movies.movie_id = movies_cities.movie_id INNER JOIN cities ON cities.CityID = movies_cities.city_id WHERE city = ? ");
...
<div class="MTRTable">
    <table class="MovieTotalRuntimeTable">
      <tr class="MoviesContent">
        ...
        <?php
            // 2. Perform database query
            $query = $newconnection->prepare("SELECT SUM(RunTime) FROM movies_cities INNER JOIN movies ON movies.movie_id = movies_cities.movie_id INNER JOIN cities ON cities.CityID = movies_cities.city_id WHERE city = ? ");
...
<div class="MTRTable">
    <table class="MovieAvgRuntimeTable">
        ...
        <?php
            // 2. Perform database query
            $query = $newconnection->prepare("SELECT AVG(RunTime) FROM movies_cities INNER JOIN movies ON movies.movie_id = movies_cities.movie_id INNER JOIN cities ON cities.CityID = movies_cities.city_id WHERE city = ? ");
...
<div class="MTRTable">
  <table class="MovieAvgRuntimeTable">
      ...
      <?php
          // 2. Perform database query
          $query = $newconnection->prepare("SELECT MIN(RunTime) FROM movies_cities INNER JOIN movies ON movies.movie_id = movies_cities.movie_id INNER JOIN cities ON cities.CityID = movies_cities.city_id WHERE city = ? ");
...
<div class="MTRTable">
    <table class="MovieAvgRuntimeTable">
        ...
        <?php
            // 2. Perform database query
            $query = $newconnection->prepare("SELECT MAX(RunTime) FROM movies_cities INNER JOIN movies ON movies.movie_id = movies_cities.movie_id INNER JOIN cities ON cities.CityID = movies_cities.city_id WHERE city = ? ");
...
<div class="MTGTable">
    <table class="MovieTotalGrossTable">
      <tr class="MoviesContent">
        ...
        <?php
            // 2. Perform database query
            $query = $newconnection->prepare("SELECT SUM(TotalWorldGross) FROM movies_cities INNER JOIN movies ON movies.movie_id = movies_cities.movie_id INNER JOIN cities ON cities.CityID = movies_cities.city_id WHERE city = ? ");
...
<div class="MTGTable">
    <table class="MovieTotalGrossTable">
      <tr class="MoviesContent">
        ...
        <?php
            // 2. Perform database query
            $query = $newconnection->prepare("SELECT MAX(TotalWorldGross) FROM movies_cities INNER JOIN movies ON movies.movie_id = movies_cities.movie_id INNER JOIN cities ON cities.CityID = movies_cities.city_id WHERE city = ? ");
...
<?php
  function individualMovieFactPageQuery($movieTitle, $city) {
    ...
    // 2. Perform database query
    $query = $newconnection->prepare("SELECT * FROM movies_cities INNER JOIN movies ON movies.movie_id = movies_cities.movie_id INNER JOIN cities ON cities.CityID = movies_cities.city_id WHERE MovieTitle = ? AND city = ? ");
...
<?php
  function individualMovieFactPageLocationQuery($movieSLUG) {
    ...
    // 2. Perform database query
    $query = $newconnection->prepare("SELECT * FROM movies_cities INNER JOIN movies ON movies.movie_id = movies_cities.movie_id INNER JOIN cities ON cities.CityID = movies_cities.city_id WHERE MoviePageLink = ? ");
...
<?php
  function individualMoviePeopleFactPageQuery($movieSLUGPeople, $job) {
    ...
    // 2. Perform database query
    $query = $newconnection->prepare("SELECT FirstName, MiddleInitialName, LastName FROM movies_peoples INNER JOIN peoples_jobs ON peoples_jobs.PeopleID = movies_peoples.people_id INNER JOIN jobs ON peoples_jobs.JobID = jobs.JobID INNER JOIN peoples ON movies_peoples.people_id = peoples.people_id INNER JOIN movies ON movies_peoples.movie_id = movies.movie_id WHERE MoviePageLink = ? and jobs = ? ");
