...
<div class="MCTable">
        ...
        <?php
            ...
            $query = $newconnection->prepare("SELECT COUNT(*) FROM movies_cities INNER JOIN movies ON movies.movie_id = movies_cities.MovieID INNER JOIN cities ON cities.CityID = movies_cities.city_id WHERE city = ? ");
...
<div class="MTRTable">
    <table class="MovieTotalRuntimeTable">
      <tr class="MoviesContent">
        ...
        <?php
            // 2. Perform database query
            $query = $newconnection->prepare("SELECT SUM(RunTime) FROM movies_cities INNER JOIN movies ON movies.movie_id = movies_cities.MovieID INNER JOIN cities ON cities.CityID = movies_cities.city_id WHERE city = ? ");
...
<div class="MTRTable">
    <table class="MovieAvgRuntimeTable">
        ...
        <?php
            // 2. Perform database query
            $query = $newconnection->prepare("SELECT AVG(RunTime) FROM movies_cities INNER JOIN movies ON movies.movie_id = movies_cities.MovieID INNER JOIN cities ON cities.CityID = movies_cities.city_id WHERE city = ? ");
...
<div class="MTRTable">
  <table class="MovieAvgRuntimeTable">
      ...
      <?php
          // 2. Perform database query
          $query = $newconnection->prepare("SELECT MIN(RunTime) FROM movies_cities INNER JOIN movies ON movies.movie_id = movies_cities.MovieID INNER JOIN cities ON cities.CityID = movies_cities.city_id WHERE city = ? ");
...
<div class="MTRTable">
    <table class="MovieAvgRuntimeTable">
        ...
        <?php
            // 2. Perform database query
            $query = $newconnection->prepare("SELECT MAX(RunTime) FROM movies_cities INNER JOIN movies ON movies.movie_id = movies_cities.MovieID INNER JOIN cities ON cities.CityID = movies_cities.city_id WHERE city = ? ");
...
<div class="MTGTable">
    <table class="MovieTotalGrossTable">
      <tr class="MoviesContent">
        ...
        <?php
            // 2. Perform database query
            $query = $newconnection->prepare("SELECT SUM(TotalWorldGross) FROM movies_cities INNER JOIN movies ON movies.movie_id = movies_cities.MovieID INNER JOIN cities ON cities.CityID = movies_cities.city_id WHERE city = ? ");
...
<div class="MTGTable">
    <table class="MovieTotalGrossTable">
      <tr class="MoviesContent">
        ...
        <?php
            // 2. Perform database query
            $query = $newconnection->prepare("SELECT MAX(TotalWorldGross) FROM movies_cities INNER JOIN movies ON movies.movie_id = movies_cities.MovieID INNER JOIN cities ON cities.CityID = movies_cities.city_id WHERE city = ? ");
...
<?php
  function individualMovieFactPageQuery($movieTitle, $city) {
    ...
    // 2. Perform database query
    $query = $newconnection->prepare("SELECT * FROM movies_cities INNER JOIN movies ON movies.movie_id = movies_cities.MovieID INNER JOIN cities ON cities.CityID = movies_cities.city_id WHERE MovieTitle = ? AND city = ? ");
...
<?php
  function individualMovieFactPageLocationQuery($movieSLUG) {
    ...
    // 2. Perform database query
    $query = $newconnection->prepare("SELECT * FROM movies_cities INNER JOIN movies ON movies.movie_id = movies_cities.MovieID INNER JOIN cities ON cities.CityID = movies_cities.city_id WHERE MoviePageLink = ? ");
