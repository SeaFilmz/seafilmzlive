    ...
    <p class="MoviesPageHeader">
      <b>
        ...
        <?php
            ...
            $query = $newconnection->prepare("SELECT * FROM movies_cities INNER JOIN movies ON movies.movie_id = movies_cities.MovieID INNER JOIN cities ON cities.CityID = movies_cities.city_id WHERE city = ? AND TotalWorldGross IS NOT NULL ORDER BY TotalWorldGross DESC ");
